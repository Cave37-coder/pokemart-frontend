  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
        ...
        <Link href="/checklists" style={{ color: "#a0a0b0", textDecoration: "none", fontSize: "14px" }}>Checklists</Link>
        <Link href="/decklist" style={{ color: "#a0a0b0", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "5px" }}>
          Deck Builder
          <span style={{
        ...
        <Link href="/sell" style={{ color: "#a0a0b0", textDecoration: "none", fontSize: "14px" }}>Sell Cards</Link>
        <Link href="/about" style={{ color: "#a0a0b0", textDecoration: "none", fontSize: "14px" }}>About</Link>
        ...
        {user ? (
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <Link href="/profile" style={{ color: "#a0a0b0", textDecoration: "none", fontSize: "13px" }}>
              🎴 {user}
            </Link>
